...
const AddProductForm = () => {
    return (
        <form className='border border-gray-200 rounded-md w-[90%] p-10'>
            <Upload /> 
            <div className="mt-5">
                <label className="text-lg text-gray-500 font-serif " htmlFor="">Product Name</label><br />
                <input type="text" className="w-full bg-gray-100 my-2 border border-gray-200 rounded py-2" required  />
            </div>
            <div>
                <label className="text-lg text-gray-500 font-serif " htmlFor="">Category</label><br />
                <input type="text" className="w-full bg-gray-100 my-2 border border-gray-200 rounded py-2" />
            </div>
            <div>
                <label className="text-lg text-gray-500 font-serif " htmlFor="">Price</label><br />
                <input type="number" className="w-full bg-gray-100 my-2 border border-gray-200 rounded py-2" />
            </div>
            <div>
                <label className="text-lg text-gray-500 font-serif " htmlFor="">Description</label><br />
