        ...
        <div className='bg-gray-100 w-full h-[100vh] flex justify-center'>
            <div className=' lg:w-[50%]  md:w-[60%] shadow-lg  lg:h-5/6 bg-white mt-16 rounded-lg text-center max-sm:p-8 '>
                <div className='font-serif max-lg:p-10' >
                    <h1 className='lg:mt-12 md:mt-12 max-sm:mt-5 text-3xl font-serif'>SignUp To Dashboard</h1>
                    ...
                    <p className='my-5 text-sm text-gray-400'> Do you already have an account? {" "} <Link to="/login"><span className='text-blue-600 underline'>Log in</span></Link> </p>
                </div>
            </div>
        </div>
    );
